...
public class GoldShulkerBoxBlock extends AbstractIronShulkerBoxBlock {
  ...
  public static final MapCodec<GoldShulkerBoxBlock> CODEC = RecordCodecBuilder.mapCodec(
    p_308835_ -> p_308835_.group(DyeColor.CODEC.optionalFieldOf("color").forGetter(p_304373_ -> Optional.ofNullable(p_304373_.color)), propertiesCodec())
      .apply(p_308835_, (p_304374_, p_304375_) -> new GoldShulkerBoxBlock(p_304375_, p_304374_.orElse(null)))
  );
