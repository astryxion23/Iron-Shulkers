...
public class IronShulkerBoxBlock extends AbstractIronShulkerBoxBlock {
  ...
  public static final MapCodec<IronShulkerBoxBlock> CODEC = RecordCodecBuilder.mapCodec(
    p_308835_ -> p_308835_.group(DyeColor.CODEC.optionalFieldOf("color").forGetter(p_304373_ -> Optional.ofNullable(p_304373_.color)), propertiesCodec())
      .apply(p_308835_, (p_304374_, p_304375_) -> new IronShulkerBoxBlock(p_304375_, p_304374_.orElse(null)))
  );
