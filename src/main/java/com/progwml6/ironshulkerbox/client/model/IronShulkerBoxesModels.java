...
public class IronShulkerBoxesModels {
  ...
  public static final ResourceLocation IRON_SHULKER_TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(IronShulkerBoxes.MOD_ID, "model/default/shulker_iron");
  public static final ResourceLocation GOLD_SHULKER_TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(IronShulkerBoxes.MOD_ID, "model/default/shulker_gold");
  public static final ResourceLocation DIAMOND_SHULKER_TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(IronShulkerBoxes.MOD_ID, "model/default/shulker_diamond");
  public static final ResourceLocation COPPER_SHULKER_TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(IronShulkerBoxes.MOD_ID, "model/default/shulker_copper");
  public static final ResourceLocation CRYSTAL_SHULKER_TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(IronShulkerBoxes.MOD_ID, "model/default/shulker_crystal");
  public static final ResourceLocation OBSIDIAN_SHULKER_TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(IronShulkerBoxes.MOD_ID, "model/default/shulker_obsidian");
  ...
  private static ResourceLocation getShulkerBoxResourceLocation(String typeName, String colorName) {
    return ResourceLocation.fromNamespaceAndPath(IronShulkerBoxes.MOD_ID, "model/" + colorName + "/shulker_" + colorName + "_" + typeName);
  }
