...
public class CrystalShulkerBoxBlockEntity extends AbstractIronShulkerBoxBlockEntity implements ICrystalShulkerBox {
  ...
  public static Block[] blocksForType() {
    return Stream.concat(Stream.of(IronShulkerBoxesBlocks.CRYSTAL_SHULKER_BOX), IronShulkerBoxesBlocks.CRYSTAL_SHULKER_BOXES.values().stream()).toArray(Block[]::new);
  }
}
